...
| TASK-20260722-008 | IN_PROGRESS | Gemini / 3.1 Pro (Low) | 2026-07-22T14:30:00Z | `agents/extractor/**`, `tests/unit/test_extractor.py`, `agents/prompts/**`, `coordination/BOARD.md`, `coordination/HANDOFFS.md` | TASK-20260722-006 | Parse deadline, technologies, eligibility và compensation; xem `coordination/GEMINI_TASK_008.md` |
